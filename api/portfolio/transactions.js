...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    try {
      ...
      // In produzione, qui faresti query a Supabase per ottenere le transazioni reali
      const transactions = [];
    ...
    console.error('Errore portfolio transactions:', error);
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        message: 'Errore durante il caricamento delle transazioni'
      }),
    };
  }
};
